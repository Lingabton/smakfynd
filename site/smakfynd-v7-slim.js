...
try {
  const sendDuration = () => {
    ...
    navigator.sendBeacon?.(ANALYTICS_URL + "/event", JSON.stringify({
      session: _sid,
      event: "session_end",
      data: {
        duration_s: duration,
        pages_viewed: performance.getEntriesByType?.("navigation")?.length || 1
      },
      page: location.hash || "/",
      device,
...
function Card({
  ...
  const foodSvg = type => {
    ...
    return React.createElement("svg", {
      ...
      transform: `translate(${ic.tx}, ${ic.ty})`,
      fill: t.txM
...
function WeeklyPick({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      height: 160,
      borderRadius: "50%",
      background: `radial-gradient(circle, ${t.wine}18, transparent 70%)`,
      pointerEvents: "none"
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "Veckans fynd")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 20,
      alignItems: "flex-start",
  ...
  }, pick.name), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: "4px 0 0",
      fontSize: 13,
      color: "#9e9588"
    }
  }, pick.sub, " \xB7 ", pick.country, pick.region ? `, ${pick.region}` : ""), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "baseline",
      gap: 14,
  ...
  }, pick.crowd_score && /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 6
  ...
  }, pick.crowd_score.toFixed(1))), pick.expert_score && /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 6
  ...
  }, pick.expert_score.toFixed(1)))), foodStr && /*#__PURE__*/React.createElement("p", {
    style: {
      margin: "10px 0 0",
      fontSize: 11,
      color: "#6b6355"
    }
  }, "Passar till ", foodStr), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 10,
      marginTop: 14
  ...
  }, "K\xF6p p\xE5 Systembolaget ", /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 10
    }
  }, "\u2197"))))));
...
function EditorsPicks({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Gabriels val"), /*#__PURE__*/React.createElement("span", {
    style: {
      color: t.txL,
      fontSize: 12
    }
  }, " \u2014 utvalda fynd vi testat"))), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 10,
      color: t.txL,
      transition: "transform 0.2s",
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        width: 4,
        height: "100%",
        background: `linear-gradient(180deg, ${t.wine}, ${t.wine}40)`,
      ...
      style: {
        ...
        fontStyle: "italic",
        paddingLeft: 14,
        borderLeft: `2px solid ${t.bdrL}`
      }
    }, "\"", pick.note, "\""), pick.food && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11,
        color: t.txL,
        marginTop: 8
      }
    }, "Passar till: ", pick.food), mp && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11,
        color: t.wine,
        marginTop: 8,
...
function FoodMatch({
  ...
  }, "Beskriv din m\xE5ltid \u2014 vi matchar vinet."))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 8
    }
  ...
  }, ["🍷", "🥂", "🍾"].map((glass, i) => /*#__PURE__*/React.createElement("span", {
    key: i,
    style: {
      fontSize: 22,
      animation: `dotPulse 1.2s ease ${i * 0.3}s infinite`
    }
...
function BarcodeScanner({
    ...
    async function loadAndStart() {
      ...
      try {
        ...
        await scanner.start({
          ...
          aspectRatio: 1.7778,
          formatsToSupport: [window.Html5QrcodeSupportedFormats?.EAN_13, window.Html5QrcodeSupportedFormats?.EAN_8, window.Html5QrcodeSupportedFormats?.CODE_128, window.Html5QrcodeSupportedFormats?.CODE_39, window.Html5QrcodeSupportedFormats?.ITF].filter(Boolean)
        }, decodedText => {
  ...
  }, "Startar kameran..."), error ? /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", {
    style: {
      color: "#ff6b6b",
      fontSize: 14,
      margin: "0 0 12px"
  ...
  }, "Tillbaka")) : /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", {
    style: {
      color: "#fff",
      fontSize: 15,
      margin: "0 0 4px",
  ...
  }, "Rikta kameran mot streckkoden"), /*#__PURE__*/React.createElement("p", {
    style: {
      color: "#ffffff80",
      fontSize: 12,
      margin: "0 0 16px"
    }
  }, "Hyllkanten eller flaskans streckkod"), /*#__PURE__*/React.createElement("button", {
    onClick: () => {
...
function StoreMode({
  ...
  const result = useMemo(() => {
    ...
    const matches = products.filter(p => String(p.nr) === query || String(p.nr) === q.trim() || p.name?.toLowerCase().includes(query) || p.sub && p.sub.toLowerCase().includes(query)).slice(0, 5);
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    cy: "13",
    r: "4"
  })))), showScanner && /*#__PURE__*/React.createElement(BarcodeScanner, {
  ...
  }, "Skanna streckkoden eller skriv vinets namn.", /*#__PURE__*/React.createElement("br", null), "Vi visar po\xE4ngen och om det finns b\xE4ttre alternativ."), /*#__PURE__*/React.createElement("button", {
    onClick: () => setShowScanner(true),
    style: {
      marginTop: 16,
      padding: "14px 24px",
...
function SmakfyndApp() {
  ...
  }, "Hela Systembolagets butikssortiment.", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", {
    style: {
      color: t.wine
    }
  ...
  }, [[reviewsStr, "omdömen"], [String(countries), "länder"], ["100%", "av Systembolaget"]].map(([num, label], i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      textAlign: "center",
  ...
  React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      onMouseEnter: e => {
        e.currentTarget.style.borderColor = t.wine + "40";
        e.currentTarget.style.boxShadow = t.sh2;
        e.currentTarget.style.transform = "translateY(-2px)";
      },
      onMouseLeave: e => {
        e.currentTarget.style.borderColor = t.bdrL;
        e.currentTarget.style.boxShadow = t.sh1;
        e.currentTarget.style.transform = "translateY(0)";
      }
    }, /*#__PURE__*/React.createElement("div", {
      style: {
    ...
    style: {
      ...
      fontWeight: 600,
      textDecoration: "none",
      boxShadow: `0 4px 16px ${t.wine}40`,
      transition: "all 0.2s",
      position: "relative"
    },
    onMouseEnter: e => {
      e.currentTarget.style.transform = "translateY(-1px)";
      e.currentTarget.style.boxShadow = `0 6px 20px ${t.wine}50`;
    },
    onMouseLeave: e => {
      e.currentTarget.style.transform = "translateY(0)";
      e.currentTarget.style.boxShadow = `0 4px 16px ${t.wine}40`;
    }
  }, "Prenumerera gratis \u2197"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 11,
      color: "#6b6355",
      margin: "12px 0 0",
  ...
  }, "Avsluta n\xE4r du vill.")), /*#__PURE__*/React.createElement("footer", {
    style: {
      marginTop: 40,
      paddingTop: 24,
