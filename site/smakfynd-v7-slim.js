...
function WineOfDay({
  ...
  const pick = useMemo(() => {
    ...
    const top = products.filter(p => p.assortment === "Fast sortiment" && p.package === "Flaska" && p.smakfynd_score >= 70 && p.price <= 250).sort((a, b) => b.smakfynd_score - a.smakfynd_score).slice(0, 80);
