...
function Card({
  ...
  }, sv.isSaved(p.nr || p.id) ? "Sparad" : "Spara"))), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 10,
      color: t.txF,
      display: "flex",
...
function FoodMatch({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, aiResult.reasoning), aiResult.mode === "question" && (() => {
    ...
    return /*#__PURE__*/React.createElement("div", null, (aiResult.questions || []).map((q, qi) => /*#__PURE__*/React.createElement("div", {
      ...
      onClick: () => freetext.trim() && handleFollowup(freetext.trim()),
...
function StoreMode({
  ...
  const result = useMemo(() => {
    ...
    const match = products.find(p => String(p.nr) === query || p.name?.toLowerCase().includes(query) || p.sub && p.sub.toLowerCase().includes(query));
    if (!match) return {
      match: null,
      alternatives: []
    };
  ...
  }, "Det h\xE4r \xE4r bland de b\xE4sta i sin prisklass."))), result && !result.match && q.length >= 2 && /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: "center",
      padding: "40px 20px",
      color: t.txL
  ...
  return /*#__PURE__*/React.createElement(SavedContext.Provider, {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        transition: "transform 0.2s",
        display: "inline-block",
        transform: tipsOpen ? "rotate(180deg)" : "rotate(0)"
      }
    }, "\u25BC")), tipsOpen && /*#__PURE__*/React.createElement("div", {
      style: {
        marginTop: 8,
        display: "flex",
        flexDirection: "column",
