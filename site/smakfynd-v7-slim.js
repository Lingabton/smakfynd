...
function Card({
  ...
  const comparison = useMemo(() => {
    ...
    const candidates = allProducts.filter(w => {
      ...
      const similarTaste = myBody && w.taste_body && Math.abs(w.taste_body - myBody) <= 1 && (!myFruit || !w.taste_fruit || Math.abs(w.taste_fruit - myFruit) <= 2);
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    const similar = allProducts.filter(w => w.category === p.category && w.package === p.package && w.assortment === "Fast sortiment" && (w.nr || w.id) !== (p.nr || p.id)).map(w => {
      ...
      return {
        ...w,
        _sim: sim,
        _sameGrape: sameGrape,
        _sameRegion: sameRegion
      };
    }).filter(w => w._sim >= 15).sort((a, b) => b._sim - a._sim).slice(0, 3);
...
function LoginModal({
  ...
  }, sent ? "Kolla din inbox" : "Logga in"), sent ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", {
    style: {
      margin: "0 0 16px",
      fontSize: 13,
      color: t.txL,
  ...
  }, "Vi har skickat en inloggningsl\xE4nk till ", /*#__PURE__*/React.createElement("strong", null, email), ". Klicka p\xE5 l\xE4nken f\xF6r att logga in."), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: "0 0 16px",
      fontSize: 12,
      color: t.txF,
  ...
  }, "Kolla din skr\xE4ppost om du inte ser mailet inom en minut."), /*#__PURE__*/React.createElement("button", {
    onClick: () => {
      setSent(false);
      setError(null);
    },
  ...
  }, "Byt email")) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", {
    style: {
      margin: "0 0 16px",
      fontSize: 13,
      color: t.txL,
  ...
  }, "Vi skickar en inloggningsl\xE4nk till din email. Inget l\xF6senord beh\xF6vs."), /*#__PURE__*/React.createElement("input", {
    type: "email",
    value: email,
  ...
  }, loading ? "Skickar..." : "Skicka inloggningslänk")), error && /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 12,
      color: t.deal,
      margin: "10px 0 0"
  ...
  }, "integritetspolicy"), ".", " ", "Ditt konto delas med ", /*#__PURE__*/React.createElement("a", {
    href: "https://quiz.smakfynd.se",
    target: "_blank",
    style: {
      color: t.txL
    }
  }, "Smakfynd Quiz"), "."), /*#__PURE__*/React.createElement("button", {
    onClick: onClose,
    style: {
      display: "block",
      margin: "12px auto 0",
...
function useAuth() {
  ...
  const syncWines = async localWines => {
    ...
    try {
      ...
      const {
        data
      } = await sb.from("saved_wines").select("wine_nr, notes").eq("user_id", session.user.id);
  ...
  return courses.map(course => {
    ...
    for (const c of course.criteria || []) {
      ...
      const scored = pool.map(p => {
        ...
        if (body) {
          if (body >= bMin && body <= bMax) fit += 3;else if (Math.abs(body - (bMin + bMax) / 2) <= 2) fit += 1;
        }
        ...
        for (const k of kw) {
          ...
          } else if ((k === "torrt" || k === "torr") && p.taste_sweet != null && p.taste_sweet <= 3) fit += 2;else if ((k === "fylligt" || k === "fyllig") && p.taste_body && p.taste_body >= 8) fit += 2;else if ((k === "lätt" || k === "fräscht") && p.taste_body && p.taste_body <= 4) fit += 2;else if ((k === "fruktigt" || k === "fruktig") && p.taste_fruit && p.taste_fruit >= 8) fit += 2;
        }
...
function Profile({
  ...
  useEffect(() => {
    ...
    setLoading(true);
    Promise.all([auth.getRatings(), auth.getAlerts(), auth.getCellar()]).then(([r, a, c]) => {
      setRatings(r);
      setAlerts(a);
      setCellar(c);
  ...
  const WineRow = ({
    ...
    }, w.sub, " \xB7 ", w.price, "\u00A0", "kr", extra ? ` · ${extra}` : "")), /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 18,
        fontWeight: 900,
        color: col,
  ...
  const tasteProfile = useMemo(() => {
    ...
    const topGrapes = {};
    liked.forEach(w => {
      const g = (w.grape || "").split(",")[0].trim();
      if (g) topGrapes[g] = (topGrapes[g] || 0) + 1;
    });
    const topCountries = {};
    liked.forEach(w => {
      if (w.country) topCountries[w.country] = (topCountries[w.country] || 0) + 1;
    });
    return {
      avgBody,
      avgFruit,
  ...
  const pillStyle = active => ({
    padding: "8px 16px",
    borderRadius: 100,
    border: active ? `1.5px solid ${t.wine}` : `1px solid ${t.bdr}`,
    background: active ? `${t.wine}0c` : "transparent",
    color: active ? t.wine : t.txM,
    fontSize: 13,
    fontWeight: active ? 600 : 400,
    cursor: "pointer",
    fontFamily: "inherit"
  ...
  if (!auth.user) {
    ...
    }, "Min sida"), /*#__PURE__*/React.createElement("p", {
      style: {
        fontSize: 13,
        color: t.txM
      }
    }, "Logga in f\xF6r att se dina sparade viner, betyg och larm."), /*#__PURE__*/React.createElement("button", {
      onClick: onClose,
      style: {
        fontSize: 12,
        color: t.txL,
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Min sida"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: t.txL
    }
  ...
  }, "Logga ut"), /*#__PURE__*/React.createElement("button", {
    onClick: onClose,
    style: {
      fontSize: 12,
      color: t.txL,
    ...
    style: pillStyle(tab === "saved")
  }, "Sparade (", sv.count, ")"), /*#__PURE__*/React.createElement("button", {
    onClick: () => setTab("ratings"),
    style: pillStyle(tab === "ratings")
  }, "Betyg (", ratings.length, ")"), /*#__PURE__*/React.createElement("button", {
    onClick: () => setTab("alerts"),
    style: pillStyle(tab === "alerts")
  }, "Larm (", alerts.length, ")"), /*#__PURE__*/React.createElement("button", {
    onClick: () => setTab("cellar"),
    style: pillStyle(tab === "cellar")
  }, "K\xE4llare (", cellar.length, ")"), /*#__PURE__*/React.createElement("button", {
    onClick: () => setTab("taste"),
    style: pillStyle(tab === "taste")
  }, "Smakprofil")), loading && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: t.txL,
      padding: "20px 0",
  ...
  }, "Laddar..."), !loading && tab === "saved" && /*#__PURE__*/React.createElement("div", null, sv.count === 0 ? /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 13,
      color: t.txL
    }
  }, "Inga sparade viner \xE4nnu. Tryck hj\xE4rtat p\xE5 ett vinkort.") : products.filter(p => sv.isSaved(p.nr)).sort((a, b) => b.smakfynd_score - a.smakfynd_score).map(w => /*#__PURE__*/React.createElement(WineRow, {
    key: w.nr,
    nr: w.nr
  }))), !loading && tab === "ratings" && /*#__PURE__*/React.createElement("div", null, ratings.length === 0 ? /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 13,
      color: t.txL
    }
  }, "Inga betyg \xE4nnu. Expandera ett vinkort och ge stj\xE4rnor.") : ratings.sort((a, b) => b.rating - a.rating).map(r => /*#__PURE__*/React.createElement(WineRow, {
    key: r.wine_nr,
    nr: r.wine_nr,
    extra: `${"★".repeat(r.rating)}${"☆".repeat(5 - r.rating)}`
  }))), !loading && tab === "alerts" && /*#__PURE__*/React.createElement("div", null, alerts.length === 0 ? /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 13,
      color: t.txL
    }
  }, "Inga aktiva larm. Tryck \"Fynd-larm\" p\xE5 ett vinkort.") : alerts.map((a, i) => /*#__PURE__*/React.createElement(WineRow, {
    key: i,
    nr: a.wine_nr,
    extra: a.alert_type === "price_drop" ? "Prissänkning" : a.alert_type === "price_below" ? `Under ${a.threshold} kr` : "Tillbaka i lager"
  }))), !loading && tab === "cellar" && /*#__PURE__*/React.createElement("div", null, cellar.length === 0 ? /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 13,
      color: t.txL
    }
  }, "Tomt i k\xE4llaren. Tryck \"L\xE4gg i k\xE4llaren\" p\xE5 ett vinkort.") : cellar.map((c, i) => /*#__PURE__*/React.createElement(WineRow, {
    key: i,
    nr: c.wine_nr,
    extra: c.status === "tasted" ? `Provad${c.personal_rating ? ` ${"★".repeat(c.personal_rating)}` : ""}${c.occasion ? ` · ${c.occasion}` : ""}` : "I källaren"
  })), cellar.filter(c => c.notes).length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 12,
      borderTop: `1px solid ${t.bdrL}`,
      paddingTop: 12
  ...
  }, "Provningsanteckningar"), cellar.filter(c => c.notes).map((c, i) => {
    ...
    }, w ? w.name : `#${c.wine_nr}`), c.occasion && /*#__PURE__*/React.createElement("span", {
      style: {
        color: t.txL
      }
    }, " \xB7 ", c.occasion), /*#__PURE__*/React.createElement("div", {
      style: {
        fontStyle: "italic",
        marginTop: 2
      }
    }, c.notes));
  }))), !loading && tab === "taste" && /*#__PURE__*/React.createElement("div", null, !tasteProfile ? /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 13,
      color: t.txL
    }
  }, "Betygs\xE4tt minst 3 viner med 4+ stj\xE4rnor f\xF6r att se din smakprofil."), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 12,
      color: t.txF
    }
  }, "Din profil ber\xE4knas fr\xE5n viner du gillat och hj\xE4lper oss rekommendera b\xE4ttre.")) : /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: t.txM,
      marginBottom: 12
    }
  }, "Baserat p\xE5 ", tasteProfile.count, " viner du gillar:"), /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 16
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "Din smak"), [["Lätt", "Fylligt", tasteProfile.avgBody, 12], ["Stram", "Fruktigt", tasteProfile.avgFruit, 12], ["Torrt", "Sött", tasteProfile.avgSweet, 12]].map(([lo, hi, val, max]) => /*#__PURE__*/React.createElement("div", {
    key: lo,
    style: {
      display: "flex",
      alignItems: "center",
  ...
  }, "Favoritdruvor"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 6,
      flexWrap: "wrap"
    }
  }, Object.entries(tasteProfile.topGrapes).sort((a, b) => b[1] - a[1]).slice(0, 5).map(([grape, count]) => /*#__PURE__*/React.createElement("span", {
    key: grape,
    style: {
      fontSize: 12,
      padding: "4px 10px",
  ...
  }, grape, " (", count, ")")))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      color: t.txL,
      textTransform: "uppercase",
  ...
  }, "Favoritl\xE4nder"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 6,
      flexWrap: "wrap"
    }
  }, Object.entries(tasteProfile.topCountries).sort((a, b) => b[1] - a[1]).slice(0, 5).map(([country, count]) => /*#__PURE__*/React.createElement("span", {
    key: country,
    style: {
      fontSize: 12,
      padding: "4px 10px",
...
function fuzzySearch(items, query, keys, limit = 10) {
  ...
  }).filter(r => r.score > 0).sort((a, b) => b.score - a.score || b.item.smakfynd_score - a.item.smakfynd_score).slice(0, limit).map(r => r.item);
}
function getRecommendations(wine, products) {
  ...
  const base = products.filter(p => p.nr !== wine.nr && p.category === wine.category && p.package === wine.package && p.assortment === "Fast sortiment" && Math.abs((p.vol || 750) - wineVol) / wineVol < 0.3);
  ...
  const betterSame = pool1.filter(p => Math.abs(p.price - wine.price) <= priceRange && p.smakfynd_score >= wine.smakfynd_score + 3).sort((a, b) => b.smakfynd_score - a.smakfynd_score);
  ...
  if (recs.length < 3) {
    const cheaper = pool1.filter(p => !used.has(p.nr) && Math.abs(p.smakfynd_score - wine.smakfynd_score) <= 3 && p.price <= wine.price * 0.75).sort((a, b) => a.price - b.price);
  ...
  // 1c. Worth upgrading
  if (recs.length < 3) {
    const upgrade = pool1.filter(p => !used.has(p.nr) && p.smakfynd_score >= wine.smakfynd_score + 5 && p.price > wine.price * 1.3 && p.price <= wine.price * 2.5).sort((a, b) => b.smakfynd_score - a.smakfynd_score);
  ...
  if (recs.length < 4 && narrow.length >= 3) {
    const broader = base.filter(p => !used.has(p.nr) && !narrow.includes(p) && p.smakfynd_score >= wine.smakfynd_score).sort((a, b) => {
      let sa = 0,
        sb = 0;
...
function availLabel(avail) {
  if (avail >= 0.7) return {
    text: "Brett tillgängligt",
    color: t.green
  };
  if (avail >= 0.3) return {
    text: "Fråga din butik",
    color: t.gold
  };
  return {
...
function LabelScanner({
  ...
  const captureAndAnalyze = async () => {
    ...
    try {
      ...
      if (!searchQuery) {
        setOcrText(data._gemini_status === 429 ? "Etikettläsningen har nått sin dagliga gräns. Prova igen imorgon, eller skriv vinets namn." : "Kunde inte läsa etiketten. Prova en tydligare bild.");
        setStatus("error");
        return;
      }
  ...
  if (status === "results") {
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, "Resultat fr\xE5n etikett"), /*#__PURE__*/React.createElement("button", {
      onClick: onClose,
      style: {
        padding: "8px 16px",
        borderRadius: 100,
    ...
    }, "St\xE4ng")), matches.length > 0 ? /*#__PURE__*/React.createElement("div", {
      style: {
        padding: "0 16px"
      }
    }, /*#__PURE__*/React.createElement("div", {
    ...
    }, "Hittade ", matches.length, " m\xF6jliga matchningar:"), matches.map((p, i) => {
      ...
      }, p.sub, " \xB7 ", p.country, " \xB7 ", p.price, "\u00A0", "kr")), /*#__PURE__*/React.createElement("span", {
        style: {
          fontSize: 20,
          fontWeight: 900,
          color: col,
    ...
    }, "Kunde inte matcha etiketten"), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: t.txL
      }
    }, "Prova att skriva vinets namn ist\xE4llet")), ocrText && /*#__PURE__*/React.createElement("div", {
      style: {
        padding: "16px",
        marginTop: 8
      }
    ...
    }, "Avl\xE4st text:"), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 10,
        color: t.txF,
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Rikta kameran mot vinets etikett"), /*#__PURE__*/React.createElement("button", {
    ...
    style: {
      ...
      borderRadius: 12,
      border: "none",
      background: status === "processing" ? "#666" : "#fff",
      color: "#000",
      fontSize: 15,
      fontWeight: 600,
      cursor: "pointer",
  ...
  }, status === "processing" ? "Läser etikett..." : "Ta bild")), /*#__PURE__*/React.createElement("button", {
    onClick: onClose,
    style: {
      position: "absolute",
      top: 16,
...
function StoreMode({
  ...
  const [recent, setRecent] = useState(() => {
    try {
      return JSON.parse(localStorage.getItem("sf_recent_snabbkoll") || "[]");
    } catch (e) {
      return [];
    }
  });
  const addRecent = wine => {
    ...
    setRecent(updated);
    try {
      localStorage.setItem("sf_recent_snabbkoll", JSON.stringify(updated));
    } catch (e) {}
  };
  useEffect(() => {
  ...
  const [eanMap] = useState(() => {
    try {
      return JSON.parse(localStorage.getItem("sf_ean_map") || "{}");
    } catch (e) {
      return {};
    }
  });
  const saveEanMapping = (ean, nr) => {
    eanMap[ean] = nr;
    try {
      localStorage.setItem("sf_ean_map", JSON.stringify(eanMap));
    } catch (e) {}
  ...
  const handleBarcodeScan = (code, format) => {
    ...
    setTimeout(() => {
      ...
      fetch(`https://smakfynd-analytics.smakfynd.workers.dev/ean?code=${code}`).then(r => r.json()).then(eanData => {
        if (eanData.nr) {
          const serverMatch = products.find(p => String(p.nr) === eanData.nr);
          if (serverMatch && !selected) {
            setQ(serverMatch.name);
            handleSelect(serverMatch);
            setScanMsg(null);
          }
        }
      }).catch(() => {});
  ...
  const RecCard = ({
    ...
    }, p.sub, " \xB7 ", p.country), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11,
        color: type === "B" ? t.green : type === "C" ? t.gold : t.txM,
        fontWeight: 500,
        marginTop: 2
      }
    }, label), /*#__PURE__*/React.createElement("div", {
    ...
    }, av.text)), /*#__PURE__*/React.createElement("div", {
      style: {
        textAlign: "center",
        flexShrink: 0
      }
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Kolla snabbt \u2014 i butik, hemma, eller p\xE5 restaurang")), /*#__PURE__*/React.createElement("button", {
    onClick: onClose,
    style: {
      padding: "8px 16px",
      borderRadius: 100,
  ...
  }, "Hela rankingen")), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "relative",
      marginBottom: 16
    }
    ...
    style: {
      ...
      borderRadius: 14,
      border: `2px solid ${selected ? t.green + "40" : t.wine + "30"}`,
      background: t.card,
      fontSize: 16,
      color: t.tx,
      outline: "none",
    ...
    x2: "17",
    y2: "8"
  })), "Skanna hyllkant"), /*#__PURE__*/React.createElement("button", {
    ...
    d: "M5 21c0-3 3-5 7-5s7 2 7 5"
  })), "Skanna etikett", /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 9,
      background: t.bg,
      padding: "1px 5px",
  ...
  }, "Senaste s\xF6kningar"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 6,
      flexWrap: "wrap"
    ...
    onClick: () => {
      setQ(r.name);
      const w = products.find(p => String(p.nr) === String(r.nr));
      if (w) handleSelect(w);
    },
    style: {
      padding: "6px 12px",
  ...
  }, r.name)))), q && !selected && results.length > 0 && /*#__PURE__*/React.createElement("div", null, results.map(p => {
    const [_l, col] = getScoreInfo(p.smakfynd_score);
    return /*#__PURE__*/React.createElement("div", {
      key: p.nr,
      onClick: () => {
    ...
    }, p.country, " \xB7 ", p.grape, " \xB7 ", p.price, "\u00A0", "kr")), /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 18,
        fontWeight: 900,
        color: col,
  ...
  })), q && q.length >= 2 && !selected && results.length === 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: "center",
      padding: "32px 20px",
      color: t.txL
  ...
  }, "B\xE4ttre alternativ"), recs.map((r, i) => /*#__PURE__*/React.createElement(RecCard, {
    key: i,
    p: r,
    label: r._recLabel,
    type: r._recType
  ...
  }, "Du gjorde r\xE4tt val"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: t.txM,
      marginTop: 2
    }
  }, "Inget b\xE4ttre i prisklassen just nu.")), (() => {
    const selVol = selected.vol || 750;
    const similar = products.filter(w => w.nr !== selected.nr && w.category === selected.category && w.package === selected.package && w.assortment === "Fast sortiment" && Math.abs((w.vol || 750) - selVol) / selVol < 0.3).map(w => {
      let sim = 0;
    ...
    }).filter(w => w._sim >= 15).sort((a, b) => b._sim - a._sim || b.smakfynd_score - a.smakfynd_score).slice(0, 3);
    if (similar.length === 0) return null;
    ...
    }, "Du kanske ocks\xE5 gillar"), similar.map((r, i) => /*#__PURE__*/React.createElement(RecCard, {
      key: i,
      p: r,
      label: `Liknande stil${r.grape && selected.grape && r.grape.toLowerCase() === selected.grape.toLowerCase() ? ", samma druva" : ""}`,
      type: "A"
    })));
  })())), !q && !selected && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 8
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "Veckans fynd"), products.filter(p => p.assortment === "Fast sortiment" && p.package === "Flaska" && p.smakfynd_score >= 78).sort((a, b) => b.smakfynd_score - a.smakfynd_score).slice(0, 5).map((p, i) => {
    const [_l, col] = getScoreInfo(p.smakfynd_score);
    return /*#__PURE__*/React.createElement("div", {
      key: i,
      onClick: () => {
    ...
    }, p.sub, " \xB7 ", p.price, "\u00A0", "kr")), /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 18,
        fontWeight: 900,
        color: col,
...
function SmakfyndApp() {
  ...
  }, [["saved", `Sparade${sv.count ? ` (${sv.count})` : ""}`], ["about", "Om"], [auth.user ? "profile" : "login", auth.user ? "Min sida" : "Logga in"]].map(([k, l]) => /*#__PURE__*/React.createElement("span", {
    key: k,
    onClick: () => {
      if (k === "login") {
        setShowLogin(true);
  ...
  }, "Swish: 0730-910551"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10,
      color: t.txF,
      marginTop: 4
  ...
  }, "St\xE4ng")), panel === "profile" && /*#__PURE__*/React.createElement(Profile, {
    products: products,
    auth: auth,
