...
function Card({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "\u2212", p.price_vs_launch_pct, "%"), !p.unrated && !p.organic && !p.price_vs_launch_pct && s100 >= 85 && /*#__PURE__*/React.createElement("span", {
    style: statusPill("Toppköp", t.green)
  }, "Toppk\xF6p"), !p.unrated && !p.organic && !p.price_vs_launch_pct && s100 >= 75 && s100 < 85 && /*#__PURE__*/React.createElement("span", {
  ...
  }, p.sub, p.vintage ? ` · ${p.vintage}` : "", p.vol && p.vol !== 750 && /*#__PURE__*/React.createElement("span", {
    style: {
      marginLeft: 4,
      fontSize: 10,
      color: t.txL
    }
  }, p.vol, " ml")), /*#__PURE__*/React.createElement("span", {
    style: {
      flexShrink: 0,
      marginLeft: 8,
      textAlign: "right"
  ...
  }, "kr")))), p.assortment && p.assortment !== "Fast sortiment" && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10,
      color: "#8a7a6a",
      marginTop: 2
    }
  }, p.assortment === "Ordervaror" ? "Beställningsvara" : p.assortment), p.assortment === "Fast sortiment" && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10,
      color: t.green,
      marginTop: 2
    }
  }, "Finns i butik"), comparison && (() => {
  ...
  }, p.unrated ? /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10,
      fontWeight: 600,
      color: "#8a7a6a",
  ...
  }, "betygsatt"), p.taste_body != null && /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 1,
      justifyContent: "center",
  ...
  }, [["F", p.taste_body], ["S", p.taste_sweet], ["Sy", p.taste_fruit]].map(([l, v]) => v != null ? /*#__PURE__*/React.createElement("div", {
    key: l,
    style: {
      fontSize: 8,
      color: "#8a7a6a",
    ...
    title: l === "F" ? "Fyllighet" : l === "S" ? "Sötma" : "Syra"
  }, l, v) : null))) : /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 26,
      fontWeight: 900,
      color: col,
...
function Profile({
  ...
  if (!auth.user) {
    ...
    }, "Logga in f\xF6r att spara viner och synka mellan enheter."), /*#__PURE__*/React.createElement("button", {
      onClick: onClose,
      style: {
        fontSize: 12,
        color: t.txL,
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Smakfynd Quiz \u2192"), /*#__PURE__*/React.createElement("span", {
    style: {
      padding: "8px 14px",
      borderRadius: 10,
      background: t.bg,
  ...
  }, "Premium \u2014 kommer snart")), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 14,
      fontFamily: t.serif,
      color: t.tx,
  ...
  }, "Sparade viner (", savedWines.length, ")"), savedWines.length === 0 ? /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 13,
      color: t.txL
    }
  }, "Inga sparade viner \xE4nnu. Tryck hj\xE4rtat p\xE5 ett vinkort.") : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 6,
      marginBottom: 10
    }
  }, [["score", "Poäng"], ["price", "Pris"], ["name", "Namn"]].map(([k, l]) => /*#__PURE__*/React.createElement("button", {
    key: k,
    onClick: () => setSortBy(k),
    style: {
      padding: "4px 10px",
      borderRadius: 8,
      border: `1px solid ${sortBy === k ? t.wine : t.bdr}`,
      background: sortBy === k ? `${t.wine}0c` : "transparent",
      color: sortBy === k ? t.wine : t.txL,
      fontSize: 11,
      cursor: "pointer",
      fontFamily: "inherit",
      fontWeight: sortBy === k ? 600 : 400
    }
  }, l))), /*#__PURE__*/React.createElement("div", null, sorted.slice(0, 30).map(w => {
    ...
    }, w.sub, " \xB7 ", w.price, "\u00A0", "kr")), /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 18,
        fontWeight: 900,
        color: col,
    ...
    }, w.smakfynd_score), /*#__PURE__*/React.createElement("button", {
      onClick: () => sv.toggle(w.nr),
      "aria-label": "Ta bort",
      style: {
        fontSize: 14,
        color: t.txL,
...
function SmakfyndApp() {
  ...
  const [showOrder, setShowOrder] = useState(() => {
    try {
      return localStorage.getItem("smakfynd_show_order") === "true";
    } catch {
      return false;
    }
  });
  ...
  const loadUnrated = async () => {
    ...
    try {
      ...
      if (typeof trackEvent === "function") trackEvent("unrated_load_fail", {
        error: String(e)
      });
  ...
  const filtered = useMemo(() => {
    ...
    if (!showOrder && !showBest) r = r.filter(p => inStore.has(p.assortment));else if (!showBest) r = r.filter(p => p.assortment === "Fast sortiment");
  ...
  return /*#__PURE__*/React.createElement(SavedContext.Provider, {
  ...
  }, "Skanna"), [["saved", `Sparade${sv.count ? ` (${sv.count})` : ""}`], [auth.user ? "profile" : "login", auth.user ? "Min sida" : "Logga in"]].map(([k, l]) => /*#__PURE__*/React.createElement("span", {
    key: k,
    onClick: () => {
      if (k === "login") {
        setShowLogin(true);
    ...
    style: pill(cat === ct.k)
  }, ct.l))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 8,
      marginBottom: 10,
      padding: "8px 12px",
      background: showOrder ? "#fefcf8" : "#f0f7f0",
      border: `1px solid ${showOrder ? t.bdrL : t.green}`,
      borderRadius: 10,
      cursor: "pointer"
    },
    onClick: () => {
      ...
      if (next) loadUnrated();
      try {
        localStorage.setItem("smakfynd_show_order", String(next));
      } catch {}
      if (typeof trackEvent === "function") trackEvent("order_toggle", {
        show_order: next
      });
    }
  }, /*#__PURE__*/React.createElement("span", {
  ...
  }, showOrder ? "\uD83C\uDFEA" : "\uD83D\uDED2"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 13,
      fontWeight: 500,
      color: showOrder ? t.txM : "#1a7a2e"
    }
  }, showOrder ? "Visar alla viner" : "Visar viner som finns i butik"), /*#__PURE__*/React.createElement("span", {
    style: {
      marginLeft: "auto",
      fontSize: 11,
      color: showOrder ? t.wine : t.txL,
      textDecoration: showOrder ? "none" : "underline",
      cursor: "pointer"
    }
  }, showOrder ? "Visa bara butik" : "Visa även beställningsvaror")), hasNonCatFilters ? /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 6,
      flexWrap: "wrap",
