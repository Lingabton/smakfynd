...
function getRecommendations(wine, products) {
  ...
  const same = products.filter(p => p.nr !== wine.nr && p.category === wine.category && p.package === wine.package && p.assortment === "Fast sortiment");
  const recs = [];
...
function BarcodeScanner({
  ...
  }, "Rikta mot streckkoden", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 11,
      opacity: 0.7
    }
  ...
  }, "Avbryt"), !scanning && /*#__PURE__*/React.createElement("button", {
    onClick: () => {
      lastScanRef.current = "";
      setScanning(true);
    },
...
function StoreMode({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    const similar = products.filter(w => w.nr !== selected.nr && w.category === selected.category && w.package === "Flaska" && w.assortment === "Fast sortiment").map(w => {
      let sim = 0;
